...
func (in *CPUTune) DeepCopyInto(out *CPUTune) {
	*out = *in
	...
	if in.EmulatorSched != nil {
		in, out := &in.EmulatorSched, &out.EmulatorSched
		*out = new(EmulatorSched)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmulatorSched) DeepCopyInto(out *EmulatorSched) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmulatorSched.
func (in *EmulatorSched) DeepCopy() *EmulatorSched {
	if in == nil {
		return nil
	}
	out := new(EmulatorSched)
